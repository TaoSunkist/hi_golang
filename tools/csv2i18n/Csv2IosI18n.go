...
func main() {
	...
	csvFilePath := "/Users/taohui/DevStation/hi_golang/src/hi_golang/tools/csv2i18n/csv/v1.0.1.6 - V1.2.1 (5).csv"
	version := "121"
	Csv2AndroidI18n(csvFilePath, version)
}

func Csv2AndroidI18n(csvFilePath, version string) {
	...
	for countryShortName, androidI18nFileValues := range androidI18nFiles {
		...
		stringsPwd := "values-" + countryShortName + "/strings" + version + ".xml"
